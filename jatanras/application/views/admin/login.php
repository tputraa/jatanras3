				...
				<div class="auth-box ">
					...
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" role="form" action="<?php echo site_url('admin/dashboard/validate_credentials'); ?>" method="POST">

								<div class="form-group">
									<label for="signin-email" class="control-label sr-only">Email</label>
									<input type="text" class="form-control" id="signin-email" value="admin1234" name="username" placeholder="Email">
								</div>
								<div class="form-group">
									<label for="signin-password" class="control-label sr-only">Password</label>
									<input type="password" class="form-control" id="signin-password" value="admin1234" name="password" placeholder="Password">
								</div>
