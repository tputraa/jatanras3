							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										...
										<h3 class="name"><?php echo $biodata->nama; ?></h3>
							...
							<div class="profile-right">
								...
								<div class="tab-content">
									<div class="tab-pane fade in active" id="tab-bottom-left1">
										<form method="post" action="<?php echo site_url('admin/profile/Update_info');?>" enctype="multipart/form-data">
									...
									<div class="tab-pane fade in" id="tab-bottom-left2">
										<form method="post" action="<?php echo site_url('admin/profile/update_avatar');?>" enctype="multipart/form-data">
											<div class="form-group">
									...
									<div class="tab-pane fade" id="tab-bottom-left3">
										...
										<form method="POST" 
											action="<?php echo site_url('admin/profile/update_pass');?>" enctype="multipart/form-data">
                                            <?php
