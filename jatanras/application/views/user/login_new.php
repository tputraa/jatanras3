						...
						<div class="content">
							...
							<form class="form-auth-small" action="<?php echo site_url('user/validate_credentials'); ?>" method="POST">
								<div class="form-group">
									...
									<input type="text" name="username" class="form-control" id="signin-email" value="121212121" placeholder="NRP" autofocus>
								</div>
								<div class="form-group">
									<label for="signin-password" class="control-label sr-only">Password</label>
									<input type="password" name="password" class="form-control" id="signin-password" value="121212121" placeholder="Password">
								</div>
