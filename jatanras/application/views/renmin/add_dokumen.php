<!-- INPUTS -->
							<div class="panel">
								...
								<form class="form-horizontal" action="<?php echo site_url('renmin/dokumen/save'); ?>" enctype="multipart/form-data" method="POST"  >
								...
								<hr/>
								<input id="imgsubbutt" type="submit" class="btn btn-warning" value="Save Details">       
