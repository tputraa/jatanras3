	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo site_url('kanit/dashboard'); ?>" class="<?php echo $page=='media' ? 'active' : ''; ?>"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>

						
						<li><a href="<?php echo site_url('kanit/dokumen');?>" class="<?php echo $page=='dokumen' ? 'active' : ''; ?>"><i class="lnr lnr-file-empty"></i> <span>Dokumen</span></a></li>
