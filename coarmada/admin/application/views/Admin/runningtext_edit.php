<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
            ...
            <li class="active">Edit Running Text</li>
          </ol>
    </section>
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  <form method="post" action="<?php echo site_url('Admin/Runningtext/Update');?>" enctype="multipart/form-data">
                ...
                <label>Judul</label>
                  <input type="text" id="judul" name="judul" 
                         ...
                         value="<?php echo $text->judul; ?>" required/>
                  <p class="required"></p>
                </div>
                <div class="form-group">
                  <label>Isi</label>
                  <br>
                  <textarea class="tinymce" name="isi" id="isi"><?php echo $text->isi; ?></textarea>
                  <p class="required"></p>
                </div>
