...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="<?php echo site_url('dashboard')?>"><img src="<?php echo base_url();?>/template/assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left" method="GET" action="<?php echo site_url('cari/dokumen')?>">
					...
					<div class="input-group">
						...
						<input type="hidden" name="page" class="form-control" value="2">
				...
				<form class="navbar-form navbar-left">
					<div class="input-group">
						<span class="input-group-btn"><button type="button" class="btn btn-flat btn-info">PANEL KASUBDIT</button></span>
					</div>
				</form>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="<?php echo site_url('profile')?>"><i class="lnr lnr-user"></i> <span>My Profile</span></a></li>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo site_url('dashboard'); ?>" class="<?php echo $page=='dashboard' ? 'active' : ''; ?>"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>

						<li><a href="<?php echo site_url('dokumen');?>" class="<?php echo $page=='dokumen' ? 'active' : ''; ?>"><i class="lnr lnr-file-empty"></i> <span>Dokumen</span></a></li>
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; <?php echo date('Y');?> <a href="https://www.haribima.id" target="_blank">Haribima</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
...
url: "<?php echo site_url('dokumen/proses_upload') ?>",
//maxFilesize: 2,
method:"post",
...
foto_upload.on("removedfile",function(a){
	...
	$.ajax({
		type:"post",
		data:{token:token},
		url:"<?php echo site_url('dokumen/remove_foto') ?>",
		cache:false,
		dataType: 'json',
		success: function(){
