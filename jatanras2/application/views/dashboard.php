...
<div class="row">
										...
										<tbody>
											<?php $no=1; foreach($dokumen as $user): ?>
							                  ...
							                  <tr>
							                    <td><?php echo $no++; ?></td>
							                    <td>
							                    	<a style="color: blue;" href="<?php echo site_url('/dokumen/edit_details/'.$user->id); ?>">
							                    		<?php echo $user->no_lp; ?>
							                    	</a>
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<form class="navbar-form navbar-left" method="POST" action="<?php echo site_url('dashboard')?>">
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Total Upload</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Total Kasubdit</span>
										</p>
									</div>
								</div> 
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Total Kanit</span>
										</p>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Total Penyidik</span>
										</p>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Total Pasal</span>
										</p>
									</div>
								</div>
