...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="<?php echo site_url('kanit/dashboard')?>"><img src="<?php echo base_url();?>/template/assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left" method="GET" action="<?php echo site_url('cari/dokumen')?>">
					...
					<div class="input-group">
						...
						<input type="hidden" name="page" class="form-control" value="3">
				...
				<form class="navbar-form navbar-left">
					<div class="input-group">
						<span class="input-group-btn"><button type="button" class="btn btn-flat btn-info">PANEL KANIT</button></span>
					</div>
				</form>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<span><?php echo $this->session->userdata('name');?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
								<li><a href="<?php echo site_url('kanit/profile');?>"><i class="lnr lnr-user"></i> <span>My Profile</span></a></li>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo site_url('kanit/dashboard'); ?>" class="<?php echo $page=='kanit/dashboard' ? 'active' : ''; ?>"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>

						
						<li><a href="<?php echo site_url('kanit/dokumen');?>" class="<?php echo $page=='kanit/dokumen' ? 'active' : ''; ?>"><i class="lnr lnr-file-empty"></i> <span>Dokumen</span></a></li>
