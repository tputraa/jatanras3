							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="tab-content">
										...
										<form class="form-horizontal" action="<?php echo site_url('kanit/dokumen/save'); ?>" enctype="multipart/form-data" method="POST"  >
				        ...
				        <?php else: ?>
											<?php foreach($dokumen as $user): ?>
							                  ...
							                  <tr>
							                    ...
							                    <td class="text-center">
							                    	<a href="<?php echo base_url('assets/uploads/'.$user->file_name)?>" download><i class="fa fa-download"></i></a>
							...
							<div>
								<div class="margin-top-10 text-center">
									<a class="btn btn-primary" href="<?php echo site_url().'kanit/dokumen'; ?>">Close</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <form enctype="multipart/form-data" action="<?php echo site_url('kanit/dokumen/upload'); ?>" method="POST">
