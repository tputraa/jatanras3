 ...
 * @since 1.0.0
 */
class Easy_Commerce_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'easy_commerce';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'easy-commerce' ), $i ),
...
// Initialize.
$easy_commerce_footer_widgets = new Easy_Commerce_Footer_Widgets();
