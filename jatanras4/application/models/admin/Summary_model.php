...
class Summary_model extends CI_Model {
	...
	public function document_selesai(){
	...
	public function record_total($usertype,$param) 
	{        
		...
		if($fromdate && $todate){
			$this->db->where('DATE(register_date) BETWEEN "'.$fromdate.'" AND "'.$todate.'" ');
		}
	...
	public function record_count_media($param) 
	{        
		$fromdate 	= $param['fromdate'];
		$todate 	= $param['todate'];

		if($fromdate && $todate){
			$this->db->where('DATE(created_date) BETWEEN "'.$param['fromdate'].'" AND "'.$param['todate'].'"');
		}
	...
	public function record_count_penyidik() 
	{        
	...
	public function record_count_renmin() 
	{        
		$query = $this->db->get($this->renmin);
		if($query->num_rows() > 0 ) 
		{
			return $query->num_rows();
		}
