							...
							<div class="profile-right">
								...
								<div class="tab-content">
									<div class="tab-pane fade in active" id="tab-bottom-left1">
										<form method="post" action="<?php echo site_url('kanit/profile/Update_info');?>" enctype="multipart/form-data">
									...
									<div class="tab-pane fade in" id="tab-bottom-left2">
										<form method="post" action="<?php echo site_url('kanit/profile/update_avatar');?>" enctype="multipart/form-data">
											<div class="form-group">
									...
									<div class="tab-pane fade" id="tab-bottom-left3">
										...
										<form method="POST" 
											action="<?php echo site_url('kanit/profile/update_pass');?>" enctype="multipart/form-data">
                                            <?php
