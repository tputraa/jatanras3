							...
							<div class="panel">
								...
								<form class="form-horizontal" action="<?php echo site_url('admin/dokumen/update'); ?>" enctype="multipart/form-data" method="POST"  >
								    ...
								    <div class="form-group">
					                 ...
					                 <div class="form-group">
					                    <label class="control-label col-sm-2" for="email">Jam Kejadian </label>
					                    <div class="col-sm-10">
					                    <div class="input-group">
					                      <input placeholder="Jam Kejadian" name="jam_kejadian" type="time" class="form-control" value="<?php echo $item['jam']; ?>" required>
					                      <div class="input-group-addon">
	...
	<script type="text/javascript">
		$(function () {
                $(document).on('click', '.media-pdf', function (e) {
                    ...
                    $.post(baseURL + 'admin/dokumen/hasil', {id: $(this).attr('data-href')},
                    function (html) {
...
<script type="text/javascript">
	$('.img-wrap .close').on('click', function() {
		...
		$.ajax({
			type:"post",
			data:{token:token},
			url:"<?php echo site_url('/admin/dokumen/remove_media') ?>",
			cache:false,
			dataType: 'json',
			success: function(){
