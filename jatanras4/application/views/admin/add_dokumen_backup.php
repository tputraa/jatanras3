<!-- INPUTS -->
							<div class="panel">
								    ...
								    <div class="form-group">
					                 ...
					                 <div class="form-group">
					                    ...
					                    <div class="input-group">
					                      <input placeholder="Jam Kejadian" name="jam_kejadian" type="time" class="form-control" required>
					                      <div class="input-group-addon">
								...
								<hr/>
								<input id="imgsubbutt" type="submit" class="btn btn-warning" value="Simpan Details">       
