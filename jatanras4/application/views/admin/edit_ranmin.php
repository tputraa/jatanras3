<!-- INPUTS -->
							<div class="panel">
								...
								<form action="<?php echo site_url('admin/renmin/save_details'); ?>" method="POST">
								<div class="panel-body">
									...
									<select required class="form-control" name="activation">
										<option value="1" <?php if(isset($item['activation'])=="1") echo 'selected="selected"'; ?>>Aktif</option>
										<option value="0" <?php if(isset($item['activation'])=="0") echo 'selected="selected"'; ?>>Tidak Aktif</option>
									</select>
									<br>
					            ...
					            <?php endif; ?>
					            <a class="btn btn-danger" href="<?php echo site_url().'admin/renmin'; ?>">Close</a>
